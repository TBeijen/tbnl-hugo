...
tags:
  ...
  - IBM
  - SFTP
description: IBM now has Terraform plus Ansible which is Terrible. Actually a great combination, that is why somewhere an in-house 'Terrible' was created many years ago.
...
{{< figure src="/img/terrible-header.jpg" title="Terrible!! BOOO!!!" >}}
...
If I remember correctly, by the end of Terrible, plan ID was around 150k. Meaning in the 7 years, on average, more than 90 plans per day. In those years as far as I know there haven't been occurrences of accidentally rolling out destructive changes[^footnote-terrible-destroy].
...
[^footnote-terrible-destroy]: I am aware people tend to become less vocal when they accidentally have destroyed an environment. Nevertheless, rumours travel fast and wide.